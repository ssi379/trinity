...
public class IntegerReadCursorCreatorTest {
  ...
  private static final String EXPECTED_CODE = "result.setValue(cursor.getInt(cursor.getColumnIndex(\"value\")));\n";

  private IntegerReadCursorCreator mIntegerReadCursorCreator;
  ...
  public void setUp() {
    ...
    mIntegerReadCursorCreator = new IntegerReadCursorCreator(setterMock, RESULT, CURSOR);
  }

  @Test
  public void create_returnsNotNull() {
    /* When */
    CodeBlock codeBlock = mIntegerReadCursorCreator.create();
