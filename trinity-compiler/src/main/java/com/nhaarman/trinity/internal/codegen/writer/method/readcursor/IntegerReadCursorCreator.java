...
class IntegerReadCursorCreator implements ReadCursorCreator {

  /**
   * Resolves to:
   * <p/>
   * result.setValue(cursor.getInt(cursor.getColumnIndex("value")));
   */
  private static final String STATEMENT = "$L.$L($L.getInt($L.getColumnIndex($S)))";
  ...
  IntegerReadCursorCreator(@NotNull final ColumnMethod column,
